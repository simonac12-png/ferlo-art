    ...
    <footer className="bg-white py-12 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 flex flex-col items-center">
        <a href="#" className="mb-4">
          <img src="/ferlo-icon.png" alt="FerLo Icon" className="h-10 opacity-80 hover:opacity-100 transition-opacity" />
        </a>
        
        <p className="text-lg font-medium text-foreground mb-8">Where art meets AI</p>
