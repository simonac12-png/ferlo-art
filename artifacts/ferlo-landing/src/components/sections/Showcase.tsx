          ...
          {showcases.map((showcase, index) => (
            ...
            >
              <div className="bg-white rounded-3xl p-4 shadow-sm border border-border mb-6 overflow-hidden">
                <div
                  className={`aspect-[4/3] rounded-2xl bg-gradient-to-br ${showcase.color} flex flex-col items-center justify-center relative overflow-hidden mb-4`}
                >
                  ...
                  <div className="w-24 h-24 border-2 border-dashed border-black/10 rounded-xl flex items-center justify-center bg-white/30 backdrop-blur-sm z-10">
                    <span className="text-sm font-medium text-black/40 text-center px-2">
                      Original
                    </span>
                  </div>
                </div>
                ...
                <div
                  className={`aspect-[4/3] rounded-2xl bg-gradient-to-br from-primary/10 to-secondary/10 flex flex-col items-center justify-center relative overflow-hidden`}
                >
